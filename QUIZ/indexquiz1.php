...
<body>
    <!-- start Quiz button -->
    <div class="start_btn"><button>MULA QUIZ 1</button></div>
    <div class="kembali_btn">
    ...
    <div class="info_box">
        ...
        <div class="info-list">
            ...
            <div class="info">5. PENTING!! Wajib tonton Video Rasmi Raudhatus Syakirin di Youtube RSG Studio sebelum
                mula.</div>
        </div>
        <div class="buttons">
    ...
    <div class="quiz_box">
        <header>
            <div class="title"> RSG QUIZ: QUIZ 1</div>
            <div class="timer">
    ...
    <div class="result_box">
        ...
        <div class="complete_text">TAHNIAH! Anda berjaya menjawab Quiz 1~</div>
